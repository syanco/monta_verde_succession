...
(abund_plot <- ggplot() +
    geom_point(data = f1est, aes(x = year_planted, y = coef, color = year_planted), alpha = .6) +
...
(mig_plot <- ggplot(mig.df) +
   geom_point(aes(x=year_planted, y = mean, color = year_planted)) +
   geom_errorbar(aes(x=year_planted, ymin = ci.low, ymax = ci.hi, color = year_planted), width =.1) +
   scale_color_manual(values = pal,
                      name = "Successional Stage", 
                      labels = c("Pasture", "T-7", "T-10", "T-15", "Old")) +
   scale_x_discrete(labels = c("Pasture", "T-7", "T-10", "T-15", "Old")) +
   ylab(expression(paste("Proportion migrants transect "^-1))) +
   xlab("Successional Stage") +
   ylim(0,1)+
   ggtitle("A") +
   theme_few() +
...
(spec_plot <- ggplot(guild.df) +
   ...
   scale_color_manual(values = pal,
                      ...
                      labels = c("Pasture", "T-7", "T-10", "T-15", "Old")) +
   scale_x_discrete(labels = c("Pasture", "T-7", "T-10", "T-15", "Old")) +
   ylab(expression(paste("Proportion specialists transect "^-1))) +
   xlab("Successional Stage") +
   ggtitle("B")+
   ylim(0,1) +
   theme_few()+
...
(total_rich_plot <- ggplot(rich) +
    geom_point(aes(x = year_planted, y = n, color = year_planted), size = 3) +
    xlab("Successional Stage") +
...
(per_rich_plot <- ggplot(rich.df) +
   geom_point(aes(x=year_planted, y = mean, color = year_planted)) +
   geom_errorbar(aes(x=year_planted, ymin = ci.low, ymax = ci.hi, color = year_planted), width =.1) +
   ylab(expression(paste("Species Richness Transect "^-1))) +
   xlab("Successional Stage") +
   scale_color_manual(values = pal,
                      name = "Successional Stage", 
                      labels = c("Pasture", "T-7", "T-10", "T-15", "Old")) +
...
(nmds <- ggplot() +
    ...
    geom_text_repel(data = species.score, aes(x=MDS1, y = MDS2, label = species),
      C              size = 2, direction = "both", force_pull = 1, segment.olor = 'transparent',
                    max.overlaps = 40) +
    theme_few())
